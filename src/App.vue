  ...
  <v-app>
    <v-app-bar app color="primary" dark height="100px">
      <div class="d-flex align-center">
        <v-img alt="ALUVAL Logo" class="shrink mr-2" contain src="@/assets/logoWeb.png" transition="scale-transition" />
      </div>
...
header.v-toolbar.detalles,
header.v-toolbar.detalles>.v-toolbar__content {
