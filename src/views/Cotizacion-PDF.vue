                ...
                <v-row style="margin-left: 10px; margin-right: 10px; margin-bottom: 5px; margin-top: 0.5px;">
                    <v-col>
                        <span class="textS">Estimado(a)
                            cliente(a): <br>
                            Conforme a lo que Ud. solicitó, le presentamos el presupuesto de los productos de acuerdo
                ...
                <v-row>
                    <v-col style="line-height: 70%; text-align: justify;">
                        <span class="textXS">
                            ...
                            - Precios unitarios en Pesos Mexicanos. Están sujetos a cambio sin previo aviso (excepto con
                            ...
                            - Si el cliente requiere que se contrate flete para entrega en su domicilio, el costo y el
                            riesgo
                            por daños correrá por su cuenta. <br>
                            - El anticipo es del 60% al aceptar el presupuesto y el resto contra aviso de entrega. <br>
                            - AluVal se reserva el derecho de propiedad de dominio de sus productos hasta que sean
                            pagados en su
                            totalidad. <br>
                            - Es obligación del cliente revisar que todos y cada uno de los conceptos cotizados sean los
                            ...
                            electrónico o
                            en las instalaciones de la Empresa con la firma de ambas partes del Presupuesto-Contrato,
                            especificándose claramente el número de presupuesto y versión. <br>
                            - Si la obra tiene modificaciones después de haber comenzado la producción, éstas deberán
                            solicitarse al agente de ventas para que envíe una nueva versión del presupuesto, misma que
                            el
                            cliente deberá firmar de conformidad. No se admiten modificaciones a la obra que no hayan
                            pasado por
                            éste procedimiento, por ejemplo notificaciones por correo electrónico o WhatsApp. <br>
                            - Los cambios de medida y/o especificaciones cambiarán los precios y/o tiempos de entrega.
                            <br>
                            - Si la obra lleva materiales especiales, que AluVal no maneje de línea y que ya hayan sido
                            pedidos
                            o fabricados, éstos no podrán ser cancelados. <br>
                            - El tiempo de entrega será pactado por ambas partes: iniciando una vez recibido el anticipo
                            y
                            ...
                            - Las tolerancias máximas en producto terminado serán de ± 2mm. de la medida de fabricación.
                            <br>
                            ...
                            fabricante.
                            Los herrajes, vinilos y felpas se colocarán en color gris o negro a menos de que el cliente
                            escoja,
                            defina o elija otro color existente. <br>
                            - En caso de producción en serie todas las medidas deben ser exactamente iguales (mediante
                            pre
                            ...
                            - El cliente debe revisar el producto y tiene hasta 24 hrs para hacer cualquier observación.
                            ...
                            porcentaje
                            de cargo extra (o se reducirá el descuento otorgado) debido a que la optimización ya no será
                            la
